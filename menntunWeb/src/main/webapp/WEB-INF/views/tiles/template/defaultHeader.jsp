          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
		   ...
		   <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li>
                <a href="${pageContext.request.contextPath}/welcome_home" >HOME</a>
              </li>
               <li>
                <a href="${pageContext.request.contextPath}/dashboard" >PMS</a>
              </li>
              <li>
                <a href="${pageContext.request.contextPath}/hrms" >HRMS</a>
              </li>
               <li>
